...
public class ControlMap{
    ...
    public static JoystickButton climbExtend = new JoystickButton(gunner, 1);
    public static JoystickButton climbRetract = new JoystickButton(gunner, 2);
    public static JoystickButton staticHookOn = new JoystickButton(gunner, 3);
    public static JoystickButton staticHookOff = new JoystickButton(gunner, 4);
